...
@ApiTags("building-common-equipment")
export class BuildingCommonEquipmentController {
  constructor(
    private readonly buildingCommonEquipmentService: BuildingCommonEquipmentService,
  ) {}

  @Post()
  create(
    @Body() createBuildingCommonEquipmentDto: CreateBuildingCommonEquipmentDto,
  ) {
    return this.buildingCommonEquipmentService.create(
      createBuildingCommonEquipmentDto,
    );
  }
  ...
  update(@Param('id') id: string, @Body() updateBuildingCommonEquipmentDto) {
    return this.buildingCommonEquipmentService.update(
      +id,
      updateBuildingCommonEquipmentDto,
    );
  }
