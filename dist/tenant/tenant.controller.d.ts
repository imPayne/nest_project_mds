...
export declare class TenantController {
    ...
    update(id: string, updateTenantDto: UpdateTenantDto): Promise<import("./entities/tenant.entity").TenantEntity>;
    remove(id: string): Promise<import("./entities/tenant.entity").TenantEntity>;
}
