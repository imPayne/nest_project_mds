...
let ApartmentTypeModule = class ApartmentTypeModule {
};
exports.ApartmentTypeModule = ApartmentTypeModule;
exports.ApartmentTypeModule = ApartmentTypeModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([apartment_type_entity_1.ApartmentTypeEntity])],
        controllers: [apartment_type_controller_1.ApartmentTypeController],
        providers: [apartment_type_service_1.ApartmentTypeService],
        exports: [apartment_type_service_1.ApartmentTypeService]
    })
], ApartmentTypeModule);
